...
void setup()
{
  ...
  // Ejemplos de control por software (descomenta para probar):
  // stateManager.setState(STATE_ACTIVE);    // Cambiar directamente al estado ACTIVE
  // stateManager.nextState();               // Pasar al siguiente estado
  // stateManager.goToPreviousState();       // Pasar al estado anterior
}

// ===================== LOOP PRINCIPAL =====================
void loop()
{
  // Actualizar el StateManager
  stateManager.tick();

  // Ejemplo de uso del StateManager
  SYSTEM_STATE currentState = stateManager.getCurrentState();

  // Aquí puedes agregar lógica específica basada en el estado actual
  // Por ejemplo:
  // if (currentState == STATE_EMERGENCY)
  // {
  //   // Lógica de emergencia
  //   Serial.println("¡MODO EMERGENCIA ACTIVO!");
  // }
